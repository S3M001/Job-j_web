...
import '../../css/Admin_modal/Admin_approval.css';
...
import {DashBoardContext} from "../../pages/Admin/AdminApplyList"
...
export default function AlertDialog6(props) {
    ...
    const methodReflesh = useContext(DashBoardContext)
    ...
    //Todo(1/19) {承認によるDB更新} 森谷
    const onClickApproval = (sw) => {
        //送信データの整形
        const sendData = {
        ...
        if(!sw){
            sendData.situation = "1.申請作成中"
        }
        // データ送信
        applyService.applicationApproval(sendData)
        .then((res) => {
            console.log("Success")
        })
        .catch((err) => {
    ...
    return (
        ...
        >
        {/* <div className="Admin_approval_width"> */}
        <div className="confirmation_width">
            <DialogTitle id="alert-dialog-title">
            <p className="Admin_approval_title">承認画面</p>
            </DialogTitle>
            <DialogContent>
            ...
            <div className="confirmation_card">
                ...
                <hr className="Admin_approval_line2"/>
                <div className="confirmation_card_texts">
                ...
                <hr className="Admin_approval_line"/>
                <div className="confirmation_card_texts">
                    <label className="confirmation_card_label7">
                ...
                <div className="Admin_approval_button_center">
                    <div className="Admin_approval_button_margin">
                        <Button className="Admin_approval_button_no" variant="contained" color="error" onClick={()=>{onClickApproval(false)}}>承認不可</Button>
                    </div>
                    {/* <Button className="detail_button_no" onClick={handleClose}>キャンセル</Button> */}
                    <Button className="Admin_approval_button_ok"variant="contained" color="primary" onClick={() => {onClickApproval(true)}} >承認</Button>   
                </div>
		    </div>
            {/* </DialogContentText> */}
            </DialogContent>
