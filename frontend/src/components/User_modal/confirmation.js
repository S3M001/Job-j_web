...
export default function AlertDialog7(props) {
    ...
    const onClickConfirmation = () => {
        ...
        //変更した申請情報の更新
        applyService.updateApplyInfoConfirmation(sendData)
        .then((res)=> {
            if(res){
                // alert("成功")
            }
    ...
    return (
        ...
        <div className="confirmation_width">
            ...
            <p className="confirmation_title">担当確認画面</p>
            </DialogTitle>
            <DialogContent>
            ...
            <div className="confirmation_button_center">
                <Button className="confirmation_button_ok"variant="contained" color="primary" onClick={() => {onClickConfirmation()}} >担当確認</Button>   
            </div>
            </DialogActions>
        </div>
        </Dialog>
